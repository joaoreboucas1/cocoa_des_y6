...
PYBIND11_MODULE(cosmolike_des_y6_interface, m)
{
  m.doc() = "CosmoLike Interface for DES-Y6 3x2pt Module";
  ...
  m.def("init_data_real",
      [](std::string cov, std::string mask, std::string data) {
        ...
        init_data_Mx2pt_N<0,3>(cov, mask, data, {0, 1, 2}); // JVR NOTE: this is where the 3x2pt is set!
      },
